...
*/
var LoadingState = new KiwiLoadingScreen('LoadingState',  'IntroState', {width:430, height: 430}, 'assets/img/loading/');
...
LoadingState.preload = function () {
    ...
    this.addImage('bg', 'assets/img/background'+dgameno+'.png');
    this.addImage('hidden_1', 'assets/img/dhidden_'+dgameno+'.png');
    this.addImage('hidden_2', 'assets/img/holding.png');
};
